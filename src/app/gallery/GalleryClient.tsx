      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/visit" className="btn-primary">Visit Manka Cafe</Link>
            <Link href="/menu" className="btn-outline">Order a Custom Latte</Link>
            <Link href="/private-bookings" className="btn-ghost">Book a Private Event</Link>
          </div>
        </div>
      </section>
